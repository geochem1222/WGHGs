...
入库判定以题名为中心：题名必须同时明确出现水体对象和 CO2、CH4、N2O、greenhouse gas 或甲烷过程词，并在题名或摘要中出现通量、排放、逸散、交换、浓度、生产、氧化、溶解态、源汇或收支等过程信号。只在摘要背景中顺带出现水体或温室气体的论文不会入库；油气藏、地质储碳、煤矿、污水反应器和海洋主题会被排除。
